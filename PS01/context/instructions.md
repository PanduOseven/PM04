**## Practical application task - PS01**
...
**- \*\*Analyse the PDD\*\* to understand the business process.**

**- \*\*Select a suitable RPA tool\*\* from the list of approved applications (UiPath, Automation Anywhere, Blue Prism, Microsoft Power Automate, Kofax RPA, WorkFusion).**

**- \*\*Develop a functional software robot\*\* that automates the order processing.**

**- \*\*Complete the practical assessment tasks\*\* outlined below.**
...
**- \*\*Trigger:\*\* New email arriving in the "<orders@mzansimart.co.za>" mailbox.**
...
**- \*\*Receive Orders Email:\*\* The bot should monitor the specified mailbox for new emails with the subject line containing "New Mzansi Mart Order."**

**- \*\*Extract Data:\*\* The bot must download the attached CSV file to a local folder and read its contents.**

**- \*\*Validate Data:\*\* The bot will perform a basic validation check on the customer\_id column to ensure all values are valid 8-digit strings.**

**- \*\*Access Order Management System:\*\* The bot should open a web browser and navigate to the Mzansi Mart Order Management System URL (<https://orders.mzansimart.co.za>).**

**- \*\*Log In:\*\* The bot will enter the username and password stored in a secure credential vault and click the "Log In" button.**

**- \*\*Process Each Order:\*\* For each row of data from the CSV file, the bot will:**

&#x20; **- Navigate to the "New Order" page.**

&#x20; **- Enter the customer\_id, product\_sku, and quantity into the corresponding fields.**

&#x20; **- Click the "Add Item" button.**

&#x20; **- Repeat until all items for the order are added.**

&#x20; **- Click the "Submit Order" button.**

**- \*\*Confirmation:\*\* Upon successful submission, the bot should capture the Order Confirmation Number from the screen and send a confirmation email to the customer's email address (from the CSV data), with the subject "Your Mzansi Mart Order is Confirmed."**

**- \*\*Error Handling:\*\* If any step fails (e.g., website element not found, invalid data), the bot should log the error and send an alert email to the RPA support team.**
...
**Using the provided PDD in the separate RPA\_PDD\_Diagram.md file, explain how you would break down the process into smaller, manageable automations. Describe the logic and flow of your solution.**
...
**Provide a code snippet from your RPA solution that demonstrates how you handle the data validation for the customer\_id field. You can use pseudocode or a real snippet from your chosen tool.**
...
**- sample\_orders\_batch\_1.csv**

**- sample\_orders\_batch\_2.csv**

**- \*\*Note:\*\* These files are provided as separate, downloadable artifacts. Use the sample\_orders\_batch\_1.csv for your initial development and the sample\_orders\_batch\_2.csv for your testing and error handling.**
